...
|サポートされる Microsoft Office の最小バージョンは Office 2010 であり、このバージョンでは [Azure Information Protection クライアント](./rms-client/aip-client.md)または RMS 共有アプリケーションが必要です。|サポートされる Microsoft Office の最小バージョンは、Office 2010 です。|
