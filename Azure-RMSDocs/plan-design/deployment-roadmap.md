...
# Azure Information Protection デプロイ ロードマップ
...
### 手順 4: Rights Management データ保護を準備する
...
### 手順 5: 必要に応じてテナント アカウントの Rights Management サービスを管理する
