...
|--------------------------|-----------------------|
|あらゆる種類のファイルを保護する|√ 初期の Rights Management の実装では、ネイティブ保護を使用して、Office ファイルのみを保護できました。 ここで、[汎用的な保護](../rms-client/sharing-app-dialog-box.md#whats-the-difference-between-generic-protection-and-built-in-native-protection)とは、あらゆる種類のファイルがサポートされることを意味します。|
