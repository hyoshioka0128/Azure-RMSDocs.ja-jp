...
|オンプレミスのサービスや Office 365 をサポートする|√ Azure RMS は [Office 365 とシームレスに](applications-support.md)連携します。[RMS コネクタ](../deploy-use/deploy-rms-connector.md)をデプロイすると、Azure RMS を次のオンプレミス サービスと使用することもできます。<br /><br />Exchange Server<br /><br />SharePoint Server<br /><br />ファイル分類インフラストラクチャを実行する Windows Server|
