...
外部の証明書の詳細については、「 [Azure Trust Center](http://azure.microsoft.com/support/trust-center/compliance/)」 (Azure セキュリティ センター) を参照してください。.

## 次のステップ

管理者とユーザーから見た Azure RMS については、「[Azure RMS の動作](what-admins-users-see.md)」を参照してください。.
