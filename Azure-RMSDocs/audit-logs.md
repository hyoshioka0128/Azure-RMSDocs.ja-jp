...
|報告者  |プラットフォーム  |Application  |アクション/説明   |
|---------|---------|---------|---------|
|Azure Information Protection: クラシックスキャナーのみ | Windows        | Office        |AIP スキャナーによってファイルがスキャンされるたびに生成されます。<br>ログには、次の詳細が含まれます。<br>-一致する情報の種類<br>-ラベル |
