...
-   **ドキュメントの更新**
    ...
    **再構成** - 「[How-to use](how-to-use-msipc.md)」 (使用方法) の説明を作成し、環境の設定とアプリケーションのテスト手順の順序を明確にしています。
