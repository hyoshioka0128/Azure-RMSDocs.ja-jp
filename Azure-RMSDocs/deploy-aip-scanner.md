...
- **複数のスキャナーの場合、最大 12**: 4 コアプロセッサ。8 GB の RAM が推奨されます (最小 4 GB)。

- **12 個を超える複数のスキャナーの場合 (最大 40)** : 8 コアプロセス。16 GB の RAM を推奨 (8 GB 以上)。
...
- 統合ラベル付けクライアントからのスキャナー: 4 時間ごと、およびサービスの開始時に実行されます。 
