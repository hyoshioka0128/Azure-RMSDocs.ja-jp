...
保護サービスが組織に対してアクティブ化されている場合は、 [Azure Information Protection 展開ロードマップ](deployment-roadmap.md)を使用して、Azure Information Protection をにロールアウトする前に他の構成手順が必要かどうかを確認します。ユーザーと管理者。 
