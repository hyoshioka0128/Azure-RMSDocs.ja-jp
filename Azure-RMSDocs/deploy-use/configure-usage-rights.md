...
|共通名: **全員に返信** <br /><br />ポリシーでのエンコード: **REPLYALL**|メール クライアントの **[全員に返信]** オプションを有効にします。ただし、 **[宛先]** または **[CC]** 行への受信者の追加はユーザーに許可しません。<br /><br />注: 別の組織に電子メールを送信する場合、受信者の Outlook クライアントまたは Outlook Web App には [全員に返信] オプションに加えて **[コンテンツの編集]、[編集]** の権限 (一般的な名前) が必要です。|Office カスタム権限: 該当なし。<br /><br />Azure クラシック ポータルでの名前: **全員に返信**<br /><br />AD RMS テンプレートでの名前: **全員に返信** <br /><br />API の定数または値: `IPC_EMAIL_REPLYALL L"REPLYALL"`|
...
|---------------------|----------------|---------------------------------|
|表示者|Azure クラシック ポータル<br /><br />Windows 用 Rights Management 共有アプリケーション<br /><br />Windows 用 Azure Information Protection クライアント|表示、開く、読み取り、返信、全員に返信<br /><br />注: 別の組織に電子メールを送信し、受信者が Outlook または Outlook Web App を使用している場合は、[返信] または [全員へ返信] にこのアクセス許可レベルを使わないでください。 代わりに、**[コンテンツの編集]、[編集]** 権限 (一般的な名前) が含まれる [レビュー担当者] を使用してください。これらの電子メール クライアントには返信が必要です。|
