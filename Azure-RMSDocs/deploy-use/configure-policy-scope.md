...
スコープ ポリシーでは、グローバル ポリシーのラベルと設定が常に継承されるため、スコープ ポリシーを作成または編集した場合は、グローバル ポリシーのラベルが表示されます。 スコープ ポリシーの編集時にグローバル ポリシーのラベルを編集することはできませんが、 グローバル ポリシーから継承されたラベルにサブラベルを追加することができます。

たとえば、グローバル ポリシーに Confidential (機密) という名前のラベルがある場合、このラベルはすべてのユーザーに表示されます。 スコープ ポリシーでこのラベルを削除したり順序を変更することはできませんが、 たとえばマーケティング部門に Confidential (機密) のサブラベルを新たに追加したスコープ ポリシーを作成して、この部門のユーザーに Confidential\Promotions (機密\プロモーション) が表示されるようにすることはできます。 また、販売部門に、Confidential (機密) に新しいサブラベルを追加した別のスコープ ポリシーを作成して、この部門のユーザーに Confidential\Partners (機密\パートナー) が表示されるようにすることもできます。 各サブラベルを異なる設定に構成して、それぞれの部門のユーザーにのみ表示させることができます。
