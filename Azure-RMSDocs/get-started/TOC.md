# [概要と詳細](/information-protection/understand-explore/what-is-information-protection)
# [はじめに](requirements-azure-rms.md)
## [必要条件](requirements.md)
...
### [手順 1: 保護の有効化](infoprotect-tutorial-step1.md)
### [手順 2: ポリシーの構成と公開](infoprotect-tutorial-step2.md)
### [手順 3: クライアントのインストール](infoprotect-tutorial-step3.md)
### [手順 4: 動作の確認 - ラベル付け、分類、保護](infoprotect-tutorial-step4.md)
### [手順 5: 動作の確認 - 保護ファイルの共有と文書の追跡](infoprotect-tutorial-step5.md)
