...
# <a name="scenario---retain-control-of-documents-stored-in-sharepoint"></a>シナリオ - SharePoint に保存されているドキュメントを管理する
...
### <a name="to-configure-the-sharepoint-library-for-irm-settings"></a>IRM 設定用の SharePoint ライブラリを構成するには
...
### <a name="it-announcement-changes-to-the-ltname-of-sharepoint-librarygt-site"></a>IT からのお知らせ: &lt;SharePoint ライブラリの名前&gt; サイトの変更
...
#### <a name="it-announcement-changes-to-the-sales-forecasts-and-reports-site"></a>IT からのお知らせ：売上の予測とレポート サイトへの変更
