...
---
# <a name="microsoft-software-license-terms-for-azure-information-protection"></a>Azure Information Protection のマイクロソフト ソフトウェア ライセンス条項
...
## <a name="1-installation-and-use-rights"></a>1.インストールおよび使用の権利
...
## <a name="2-data-collection"></a>2.データ収集
...
## <a name="3-scope-of-license"></a>3.ライセンスの適用範囲 
...
## <a name="7-binding-arbitration-and-class-action-waiver"></a>7.拘束力のある仲裁および集団訴訟権の放棄
...
## <a name="8-entire-agreement"></a>8.完全合意
本ライセンス条項およびマイクロソフトが追加ソフトウェア、更新プログラム、または第三者のアプリケーションについて提供する他のすべての条項は、本ソフトウェアに関する完全合意です。

## <a name="9-applicable-law-and-place-to-resolve-disputes"></a>9.準拠法および紛争解決の場所
...
## <a name="10-consumer-rights-regional-variations"></a>10.消費者の権利、地域による差異
...
## <a name="french-franais"></a>フランス語 (Français)
