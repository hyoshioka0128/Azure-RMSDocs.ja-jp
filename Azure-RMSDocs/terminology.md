...
|Azure Information Protection 統合ラベル付けクライアント|現在、プレビュー期間中: Windows コンピューターのクライアント。これにより、ユーザー、管理者、およびサービスは、Office 365 セキュリティ/コンプライアンス センターから機密ラベルとポリシー設定を使用できます。|
