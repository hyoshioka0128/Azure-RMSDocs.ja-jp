...
必要なものは、Windows 7 with Service Pack 1 以降を搭載しているコンピューターだけです。 次に、この無料のアプリケーションをマイクロソフトから [ダウンロードしてインストール](https://go.microsoft.com/fwlink/?LinkId=303970) します。
