...
|**一般保護**|このオプションをオンにすると、選んだファイルをネイティブ保護できなくなります。 詳細については、 [一般的な保護と組み込みの (ネイティブ) 保護の違い](#what-s-the-difference-between-generic-protection-and-built-in-native-protection-) 」を参照してください。|
...
|**他のユーザーがこのドキュメントを開こうとしたら電子メールで通知する**|注: このオプションは、現在プレビュー段階です。<br /><br />だれかが保護ドキュメントを開こうとしたときに電子メール通知を受信する場合、このオプションを選びます。 電子メール メッセージには、だれが、いつ開こうと試みたか、成功したかどうかが示されます。<br /><br />このオプションは、組織で Azure RMS を使用する場合にのみ機能します。 組織で、オンプレミス バージョンの Rights Management (AD RMS) を使用している場合、このオプションは表示されません。|
