...
|**他のユーザーがこのドキュメントを開こうとしたら電子メールで通知する**|注: このオプションは、現在プレビュー段階です。<br /><br />だれかが保護ドキュメントを開こうとしたときに電子メール通知を受信する場合、このオプションを選びます。 電子メール メッセージには、だれが、いつ開こうと試みたか、成功したかどうかが示されます。<br /><br />このオプションは、組織で Azure Information Protection を使用する場合にのみ機能します。 組織で、オンプレミス バージョンの Rights Management (AD RMS) を使用している場合、このオプションは表示されません。|
|**これらのドキュメントへのアクセスをすぐに取り消せるようにする**|このオプションは、後で、ドキュメント追跡サイトを使用し、ドキュメントに対するアクセスを失効させ、失効をすぐに反映する必要がある場合に選びます。 ただし、このオプションを選ぶと、ドキュメントが失効していないときに、ユーザーがドキュメントにアクセスして読み取るたびに、インターネット接続が必要になります。 ユーザーがデバイスをインターネットに接続できないシナリオや、意図したとおりにユーザーがドキュメントを表示できないシナリオがあります。<br /><br />このオプションを選ばない場合、ドキュメント追跡サイトを使用して、後でドキュメントを失効させることができます。 ただし、ドキュメントを表示するために常にインターネット接続が必須ではないので、ドキュメントが失効したことにすぐに気づかず、次回の Azure RMS の認証まで引き続き読み取ることができます。 既定では、失効させた保護ドキュメントを他のユーザーが継続して読み取ることができる最大日数は 30 日間ですが、管理者はこの値を 30 日間未満または 30 日より長い期間に変更する可能性があります。<br /><br />このオプションは、組織で Azure Information Protection を使用する場合にのみ機能します。 組織で、オンプレミス バージョンの Rights Management (AD RMS) を使用している場合、このオプションは表示されません。|

## <a name="whats-the-difference-between-generic-protection-and-built-in-native-protection"></a>一般的な保護と組み込みの (ネイティブ) 保護の違い
