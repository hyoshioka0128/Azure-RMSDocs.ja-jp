...
# Microsoft Rights Management 共有アプリケーションの技術的概要
...
> [!WARNING] ファイル名拡張子に基づいて検査とアクションを実行するファイアウォール、Web プロキシ、またはセキュリティ ソフトウェアがある場合は、新しいファイル名拡張子をサポートするようにそれらの再構成が必要になる場合があります。
...
|。jfif|。pjfif|
|。jt|。pjt|
¹ PDF Rendering Powered by Foxit。 Copyright © 2003–2014 by Foxit C』または「p』または「ation。
