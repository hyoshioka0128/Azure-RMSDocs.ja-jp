...
2. **[Microsoft Azure Information Protection]** ダイアログ ボックスで、以下を指定します。
    ...
    Azure Information Protection クライアントの現在のプレビュー バージョンをお持ちであれば、代わりに **[Select users, groups, or organization]\(ユーザー、グループ、または組織を選択\)** ボタンを利用できます。 このボタンを押すと、オンプレミス Active Directory の **[ユーザーまたはグループの選択]** ダイアログ ボックスが表示されます。 指定するユーザーまたはグループが Active Directory にある場合、このダイアログ ボックスからそれを検索し、選択できます。 このオプションを使用するには、コンピューターが内部ネットワークに接続されている必要があり、ドメインに参加している必要があります。また、オンプレミス Active Directory を用意する必要があります。 以上の条件が満たされていない場合、**[場所が見つからないため、必要なダイアログ ボックスを開くことができません。]** というメッセージが表示されます。
...
4. カスタムのアクセス許可オプションを選択した場合は、次の項目を指定します。
    ...
    あるいは、**[Select users, groups, or organization]\(ユーザー、グループ、または組織を選択\)** ボタンを使用し、Outlook のアドレス帳からユーザーまたはグループを選択できます。 Azure Information Protection クライアントの現在のプレビュー バージョンをお持ちであれば、このボタンを押すと、オンプレミス Active Directory の **[ユーザーまたはグループの選択]** ダイアログ ボックスが表示されます。 指定するユーザーまたはグループが Active Directory にある場合、このダイアログ ボックスからそれを検索し、選択できます。 このオプションを使用するには、コンピューターが内部ネットワークに接続されている必要があり、ドメインに参加している必要があります。また、オンプレミス Active Directory を用意する必要があります。 以上の条件が満たされていない場合、**[場所が見つからないため、必要なダイアログ ボックスを開くことができません。]** というメッセージが表示されます。
