...
|中央レポート機能 (分析):| **はい** | **あり** | いいえ |
|ラベルとは別に設定するカスタムのアクセス許可:| **はい** | **はい** <sup>3</sup>| いいえ |
|Office アプリの Information Protection バー: | **はい** | **あり**| いいえ |
|ラベルアクションとしての視覚的なマーキング (ヘッダー、フッター、透かし):| **はい** | **あり** | **あり**|
|アプリごとの視覚的マーキング:| **はい** | **あり** | いいえ |
|変数を使用した動的な視覚的マーキング:| **はい** | **あり** | いいえ |
|ファイルエクスプローラーでラベルを付ける:| **はい** | **あり** | いいえ |
|保護されたファイルのビューアー (テキスト、画像、PDF、pfile):| **はい** | **あり** | いいえ|
|ラベルを適用するための PPDF のサポート:| **はい** | いいえ | いいえ |
|PowerShell のラベル付けコマンドレット:| **はい** | **はい** <sup>4</sup> | いいえ |
|保護アクションに対するオフライン サポート:| **はい** | **はい** <sup>5</sup> | **はい** |
|切断されたコンピューターの手動ポリシーファイル管理:| **はい** |**あり**| いいえ |
