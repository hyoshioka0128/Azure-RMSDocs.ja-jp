...
|手動によるラベル付け:| **○** | **○** |**○** |
|既定のラベル:| **○** | **○** | **○** |
|推奨または自動ラベル付け: <br />-Word、Excel、PowerPoint の場合| **○** | **○** | **○** |
|推奨または自動ラベル付け:<br />-Outlook の場合| **○** | **○** | いいえ |
|必須ラベル:| **○** | **○** | いいえ |
|ラベルに対するユーザー定義のアクセス許可: <br />-メールの転送不可| **○** | **○** | **○** |
|ラベルに対するユーザー定義のアクセス許可: <br />-Word、Excel、PowerPoint、エクスプローラーのカスタムアクセス許可| **○** | **○** | いいえ |
|ラベルの多言語サポート:| **○** | **○** |**○** |
...
|PowerShell のラベル付けコマンドレット:| **○** | **はい** <sup>4</sup> | いいえ |
|保護アクションに対するオフライン サポート:| **○** | **可** <sup>5</sup> | **○** |
|切断されたコンピューターの手動ポリシーファイル管理:| **○** |**○**| いいえ |
|HYOK のサポート:| **○** | いいえ | いいえ |
|イベントビューアーの使用状況ログ:| **○** | いいえ |いいえ |
|Outlook の [転送不可] ボタンを表示します。| **○** | いいえ | いいえ |
|保護されたトラックの文書化:| **○** | **はい** <sup>6</sup> | いいえ |
|保護されたドキュメントの取り消し:| **○** | いいえ | いいえ |
|保護のみモード (ラベルなし):| **○** | いいえ | いいえ |
