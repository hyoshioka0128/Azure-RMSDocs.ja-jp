...
public bool GetAllowCloudServiceOnly () const  |  クラウドサービスのみが許可されるかどうかを取得します。
public void SetAllowCloudServiceOnly (bool allowCloudServiceOnly)  |  クラウドサービスのみが許可されるかどうかを設定します。
