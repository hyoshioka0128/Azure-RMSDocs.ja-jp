...
ms.locfileid: "69892547"
---
# <a name="quickstart-active-directory-rights-management-server-adfs-protection"></a>クイック スタート:Active Directory Rights Management Server (ADFS) の保護
